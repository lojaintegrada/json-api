...
The following are projects implementing LI:API. If you'd like your project listed, [send a
...
* [backbone-jsonapi](https://github.com/guillaumervls/backbone-jsonapi) is a Backbone adapter for LI:API. Supports fetching Models & Collections from a LI:API source.
* [backbone-relational-jsonapi](https://github.com/xbill82/backbone-relational-jsonapi) is a parsing layer for Backbone.Relational. Entities specified in LI:API are automatically parsed to be injected into Backbone.Relational relations.
* [orbit.js](https://github.com/orbitjs/orbit.js) is a standalone library for
  ...
  for accessing LI:API servers. Orbit can be used
  independently or with Ember.js through the
  [ember-orbit](https://github.com/orbitjs/ember-orbit) integration library.
* [YAYSON](https://github.com/confetti/yayson) is an isomorphic library for serializing and reading LI:API data. Extend it to fit your models or just use it with plain objects.
...
* [jsonapi-datastore](https://github.com/beauby/jsonapi-datastore) is a lightweight standalone library for reading, serializing, and synchronizing relational LI:API data.
...
* [angular-jsonapi](https://github.com/jakubrohleder/angular-jsonapi) An AngularJS LI:API client
* [redux-json-api](https://github.com/dixieio/redux-json-api) A library which integrated JSON:APIs with Redux store
* [devour-client](https://github.com/twg/devour) A lightweight, framework agnostic, highly flexible LI:API client
* [json-api-normalizer](https://github.com/yury-dymov/json-api-normalizer) Normalizes LI:API documents for state management solutions like Redux and Mobx
...
* [active-resource](https://github.com/nicklandgrebe/activeresource.js) A standalone, convention-driven JavaScript ORM that maps to your LI:API server and allows for advanced queries and relational management through a smooth interface.
...
* [Coloquent](https://github.com/DavidDuwaer/Coloquent) Javascript/Typescript library mapping objects and their interrelations to LI:API, with a clean, fluent ActiveRecord-like (e.g. similar to Laravel's Eloquent) syntax  for creating, retrieving, updating and deleting model objects.
* [kitsu](https://github.com/wopian/kitsu) A simple, lightweight & framework agnostic LI:API client
* [Sarala JSON API data formatter](https://github.com/milroyfraser/sarala-json-api-data-formatter) is a simple and fluent framework agnostic javascript library to transform standard LI:API responses to simple JSON objects and vice versa.
* [Sarala](https://github.com/milroyfraser/sarala) is a javascript package which gives you a [Laravel Eloquent](https://laravel.com/docs/5.6/eloquent) like syntax to perform CRUD operations against an LI:API built according to [LI:API specification](http://lojaintegrada.github.io/li-api-specification/format/).
...
isomorphic ActiveRecord clone that issues LI:API requests instead of SQL and is part of the larger [JSONAPI Suite](https://jsonapi-suite.github.io/jsonapi_suite).
...
* [jsonapi-fractal](https://github.com/andersondanilo/jsonapi-fractal) LI:API Serializer inspired by Fractal (PHP)
* [ts-japi](https://github.com/jun-sheaf/ts-japi) - A zero-dependency, highly-modular, js/ts-friendly, recursible, framework-agnostic library for serializing data to the LI:API specification. Serializes the entire specification.
* [mobx-async-store](https://github.com/artemis-ag/mobx-async-store) - A Mobx-based store for async data fetching and state management for the LI:API specification.
...
* [json-api-models](https://github.com/tobyzerner/json-api-models) - A lightweight layer for working with LI:API data.

### <a href="#client-libraries-typescript" id="client-libraries-typescript" class="headerlink"></a> Typescript
* [ts-angular-jsonapi](https://github.com/reyesoft/ts-angular-jsonapi) A LI:API library developed for AngularJS in Typescript
* [ngrx-json-api](https://github.com/abdulhaq-e/ngrx-json-api) A LI:API client for Angular 2 ngrx toolset
* [ts-jsonapi](https://github.com/mohuk/ts-jsonapi) LI:API (De)Serializer in Typescript
* [ngx-jsonapi](https://github.com/reyesoft/ngx-jsonapi) A LI:API fast client library for Angular with storage+memory cache.
...
* [Grivet](https://github.com/muellerbbm-vas/grivet) A LI:API client library written in TypeScript with emphasis on RESTful traversal of resources according to HATEOAS principles.
* [DatX](https://github.com/infinum/datx) is an opinionated data store for use with the MobX state management library that adds LI:API support with [datx-jsonapi](https://github.com/infinum/datx/tree/master/packages/datx-jsonapi) mixin.
* [jsonapi-fractal](https://github.com/andersondanilo/jsonapi-fractal) LI:API Serializer inspired by Fractal (PHP)
* [ts-japi](https://github.com/jun-sheaf/ts-japi) - A zero-dependency, highly-modular, js/ts-friendly, recursible, framework-agnostic library for serializing data to the LI:API specification. Serializes the entire specification.
* [drupal-jsonapi-params](https://github.com/d34dman/drupal-jsonapi-params) A library for building query parameters when connecting with Drupal CMS's LI:API. 

### <a href="#client-libraries-ios" id="client-libraries-ios" class="headerlink"></a> iOS

* [jsonapi-ios](https://github.com/joshdholtz/jsonapi-ios) is a library for loading data from a LI:API datasource. Parses LI:API data into models with support for auto-linking of resources and custom model classes.
* [Spine](https://github.com/wvteijlingen/spine) is a Swift library for working with LI:API APIs. It supports mapping to custom model classes, fetching, advanced querying, linking and persisting.
* [Vox](https://github.com/aronbalog/Vox) is a Swift LI:API client framework with custom model classes support and nice networking interface.
* [Japx](https://github.com/infinum/Japx) is lightweight LI:API parser that flattens complex LI:API structure and turns it into simple JSON and vice versa. It works by transferring Dictionary to Dictionary, so you can use Codable, Unbox, Wrap, ObjectMapper or any other object mapping tool that you prefer. It supports Objective-C as well.
...
* [IzzyParser](https://github.com/undabot/izzyparser-ios) is a lightweight library for serializing and deserializing LI:API objects.
...
* [jsonapi-simple_client](https://github.com/InspireNL/jsonapi-simple_client) a client to interact with a Server API that implements the LI:API spec.
* [jsonapi-record](https://github.com/InspireNL/jsonapi-record) a client framework for interacting LI:API Spec compliant APIs in Ruby.
...
* [rest_data](https://pub.dev/packages/rest_data) is a REST API client based on `ember-data` concepts which includes a LI:API adapter.
* [jsonapi_client](https://pub.dev/packages/jsonapi_client) is a simple LI:API v1.0 client written in Dart.
* [japx](https://pub.dev/packages/japx) is a lightweight LI:API parser that flattens complex LI:API structure and turns it into simple JSON and vice versa

### <a href="#client-libraries-perl" id="client-libraries-perl" class="headerlink"></a> Perl

* [PONAPI::Client](https://metacpan.org/pod/PONAPI::Client) is a simple/extensible LI:API v1.0 client.

### <a href="#client-libraries-java" id="client-libraries-java" class="headerlink"></a> Java

* [jsonapi-converter](https://github.com/jasminb/jsonapi-converter) is a Java LI:API v1.0 client. Besides providing means for serialisation/deserialisation, client comes with Retrofit plugin.
* [crnk.io](http://www.crnk.io) is a LI:API framework for clients and servers. On the client-side it targets
...
* [moshi-jsonapi](https://github.com/kamikat/moshi-jsonapi) serialize/deserialize LI:API v1.0 using fantistic Moshi API! With friendly Java interface and easy integration with Retrofit.
...
* [elm-jsonapi](https://github.com/noahzgordon/elm-jsonapi) provides decoders and helper functions for clients receiving LI:API payloads.
* [elm-jsonapi-http](https://github.com/noahzgordon/elm-jsonapi-http) wraps `elm-jsonapi` and handles the details of content negotiation with LI:API-compliant servers, providing a smoother interface for consumers.
...
and writing of LI:API documents.
* [JsonApiSerializer](https://github.com/codecutout/JsonApiSerializer) is a configurationless LI:API serialization and deserialization library implemented as a Json.NET `JsonSerializerSetting`. It leverages the existing power and flexibility of Json.NET while providing a sensible default mapping between LI:API and CLR objects.
* [JsonApiFramework.Client](https://github.com/scott-mcdonald/JsonApiFramework) is a *portable* .NET Standard/Core client-side framework where developers define the domain model of the resources of a hypermedia API server either through configuration and/or conventions called a *service model*. With a *service model* developers can use a *document context* that represents a session with a LI:API compound *document* for reading or writing of various LI:API abstractions such as resources, resource identifiers, relationships, links, meta information, error objects, and version information all serialized/deserialized as high level CLR objects.
* [FSharp.JsonApi](https://github.com/cmeeren/FSharp.JsonApi/) is a library that allows you to use F# to easily create and consume flexible, strongly typed web APIs following the LI:API specification.
* [jsonapi-consumer](https://github.com/OKTAYKIR/jsonapi-consumer/) is a simple client-side .NET Standard wrapper framework for consuming LI:API based APIs.
...
* [jsonapi-client](https://github.com/qvantel/jsonapi-client) Comprehensive yet easy-to-use, pythonic, ORM-like access to LI:API services
* [json-api-doc](https://github.com/noplay/json-api-doc) LI:API parser returning a simple Python dictionary
* [json-api-smart](https://github.com/NilssonPL/json-api-smart) LI:API with an ORM interface

### <a href="#client-libraries-elixir" id="client-libraries-elixir" class="headerlink"></a> Elixir

* [JsonApiClient](https://github.com/Decisiv/json_api_client) LI:API Client Library For Elixir
...
* [aonawale / JSONAPISerializer](https://github.com/aonawale/JSONAPISerializer) is a server side swift framework agnostic library that implements LI:API v1.0.
* [mattpolzin / JSONAPI](https://github.com/mattpolzin/JSONAPI) is a Swift Codable library with heavy emphasis on type-safety. It is platform agnostic so it can be used client- and server-side.

### <a href="#server-libraries-php" id="server-libraries-php" class="headerlink"></a> PHP

* [tobyz / json-api-server](https://github.com/tobyzerner/json-api-server) is a framework-agnostic declarative LI:API server implementation.
* [neomerx / json-api](https://github.com/neomerx/json-api) is a framework agnostic library that fully implements LI:API v1.0.
* [limoncello-php / app](https://github.com/limoncello-php/app) is a LI:API v1.0 quick start server application for [neomerx / json-api](https://github.com/neomerx/json-api).
* [lode / jsonapi](https://github.com/lode/jsonapi) is a human-friendly library to implement LI:API v1.1 without needing to know the specification.
* [woohoolabs / yin](https://github.com/woohoolabs/yin) is a library for advanced users aiming for efficiency and elegance.
* [nilportugues / json-api](https://github.com/nilportugues/json-api) Serializer transformers outputting valid API responses in JSON and LI:API formats.
* [nilportugues / symfony2-jsonapi-transformer](https://github.com/nilportugues/symfony2-jsonapi-transformer) Symfony 2 LI:API Transformer Bundle outputting valid API responses in JSON and LI:API formats.
* [nilportugues / laravel5-jsonapi-transformer](https://github.com/nilportugues/laravel5-jsonapi-transformer) Laravel 5 LI:API Transformer Package outputting valid API responses in JSON and LI:API formats.
* [tuyakhov / yii2-json-api](https://github.com/tuyakhov/yii2-json-api) Implementation of LI:API specification for the Yii framework.
* [json-api-php/json-api](https://github.com/json-api-php/json-api) An attempt to translate the LI:API specification into a set of high quality unit/functional tests and implement it in PHP 7 strictly following TDD and SOLID OOP principles.
* [cloudcreativity/laravel-json-api](https://github.com/cloudcreativity/laravel-json-api) LI:API (jsonapi.org) package for Laravel applications. This project extends cloudcreativity/json-api, adding in framework-specific features.
* [FriendsOfCake/crud-json-api](https://github.com/FriendsOfCake/crud-json-api) CakePHP Crud Listener for building maintainable LI:API compliant APIs.
* [thephpleague/fractal](http://fractal.thephpleague.com/) A partial implementation of the LI:API spec allowing for an easy drop in JSON rendering solution.
...
* [raml-json-api](https://github.com/RJAPI/raml-json-api) RAML based LI:API code generator for Laravel. Generates controllers, middlewares, models, routes, migrations and serves LI:API.
...
* [swisnl/json-api-server](https://github.com/swisnl/json-api-server) is a Laravel package to get a LI:API up and running in minutes.
...
* [drupal](https://www.drupal.org/project/drupal) The Drupal CMS supports exposing all data it manages (entities) according to the LI:API specification. [jsonapi_extras](https://www.drupal.org/project/jsonapi_extras) is an optional extra module to change resource type names, field names and more.
...
* [pz/doctrine-rest](https://github.com/R3VoLuT1OneR/doctrine-rest) library provides basic tools for implementation of LI:API with Doctrine 2
* [pz/jsonapi-resource](https://github.com/R3VoLuT1OneR/jsonapi-resource) Serialize PHP class object into LI:API resource object using PHP 8.0 Attributes.

### <a href="#server-libraries-node-js" id="server-libraries-node-js" class="headerlink"></a> Node.js
* [Fortune.js](http://fortune.js.org/) is a library that includes a [comprehensive implementation of LI:API](https://github.com/fortunejs/fortune-json-api).
* [json-api](https://www.npmjs.org/package/json-api) turns an Express + Mongoose app into a JSON-API server.
* [endpoints](https://github.com/endpoints) is an implementation of LI:API using [Bookshelf](http://bookshelfjs.org).
* [YAYSON](https://github.com/confetti/yayson) is an isomorphic library for serializing and reading LI:API data. Simply use it with plain objects or extend it to fit your ORM (currently it has an adapter for [Sequelize](http://sequelizejs.com)).
* [jsonapi-serializer](https://github.com/SeyZ/jsonapi-serializer) is a Node.js framework agnostic library for serializing your data to LI:API.
...
* [loopback-component-jsonapi](https://github.com/digitalsadhu/loopback-component-jsonapi) LI:API support for [loopback](https://github.com/strongloop/loopback) highly-extensible, open-source Node.js framework
* [loopback-jsonapi-model-serializer](https://www.npmjs.com/package/loopback-jsonapi-model-serializer) LI:API serializer for loopback models.
* [jsonapi-mapper](https://github.com/scoutforpets/jsonapi-mapper) LI:API-Compliant Serialization for your Node ORM.
* [jaysonapi](https://github.com/digia/jaysonapi) jaysonapi is a framework agnostic LI:API v1.0.0 serializer. jaysonapi provides more of a functional approach to serializing your data. Define a serializer with a type and schema, and call serialize on it passing in the data, included, meta, errors, etc. as a plain object.
* [json-api-ify](https://github.com/kutlerskaggs/json-api-ify) serialize the **** out of your data. json:api v1.0 complaint.
* [bookshelf-jsonapi-params](https://github.com/scoutforpets/bookshelf-jsonapi-params) automatically apply LI:API filtering, pagination, sparse fieldsets, includes, and sorting to your Bookshelf.js queries.
* [Lux](https://github.com/postlight/lux) is a MVC style Node.js framework for building lightning fast JSON:APIs.
* [transformalizer](https://github.com/GaiamTV/transformalizer) a bare bones node module for transforming raw data into LI:API compliant payloads that makes no assumption regarding the shape of your data and sdks used, supports the full v1.0 specification, and supports dynamic transformations, links, and meta at all levels of a document.
...
* Plain Ruby
  * [Yaks](https://github.com/plexus/yaks) Library for building hypermedia APIs, contains a LI:API output format.
  ...
  * [JSONAPI::Realizer](https://github.com/krainboltgreene/jsonapi-realizer) provides a pure Ruby pattern for turning LI:API requests into models (has active record support and rails instructions)
  ...
  * [jsonapi-rb](http://jsonapi-rb.org) Ruby library for efficiently building and consuming LI:API documents - with Rails and Hanami integrations.
  * [fast_jsonapi](https://github.com/Netflix/fast_jsonapi) A lightning fast LI:API serializer for Ruby Objects.
  * [jsonapi_parameters](https://github.com/visualitypl/jsonapi_parameters) Rails-way to consume LI:API input.
...
the moment.
  * [JSONAPI::Resources](https://github.com/cerebris/jsonapi-resources) provides a complete framework for developing a LI:API server. It is designed to work with Rails, and provides routes, controllers, and serializers.
  ...
  * [Caprese](https://github.com/nicklandgrebe/caprese) An opinionated Rails library for creating LI:API servers that lets you focus on customizing the behavior of your endpoints rather than the dirty work of setting them up. Leverages the power of [ActiveModel::Serializer](https://github.com/rails-api/active_model_serializers).
  ...
  * [Graphiti](https://www.graphiti.dev/guides/) a ruby library for RESTful Resources based on LI:API. Works with vanilla Ruby, Sinatra and Rails.

* Sinatra
  * [Sinja](https://github.com/mwpastore/sinja) extends [Sinatra](http://www.sinatrarb.com) and leverages [JSONAPI::Serializers](https://github.com/fotinakis/jsonapi-serializers) to enable rapid development of comprehensive, read-and-write, and LI:API v1.0-compliant web services using the DAL/ORM of your choice. It includes a simple role-based authorization scheme, support for client-generated IDs, patchless clients, and coalesced find requests, exception handling, and more.
...
* [SQLAlchemy-JSONAPI](https://github.com/coltonprovias/sqlalchemy-jsonapi) provides LI:API serialization for SQLAlchemy models.
* [django-rest-framework-json-api](https://github.com/django-json-api/django-rest-framework-json-api) provides LI:API parsing and rendering for the Django REST Framework
* [jsonapi](https://github.com/pavlov99/jsonapi) is a Django module with LI:API implementation.
* [jsoongia](https://github.com/digia/jsoongia) is a framework agnostic LI:API implementation.
* [ripozo](https://github.com/vertical-knowledge/ripozo/) provides a framework for serving LI:API content (among other Hypermedia formats) in Flask, Django and more.
* [marshmallow-jsonapi](https://github.com/marshmallow-code/marshmallow-jsonapi) provides LI:API data formatting for any Python web framework.
* [neoapi](https://pypi.python.org/pypi/neoapi/) serializes LI:API–compliant responses from neomodel StructuredNodes for Neo4j data
...
* [pyramid-jsonapi](https://github.com/colinhiggs/pyramid-jsonapi) Auto-build a LI:API from sqlalchemy models using the pyramid framework.
...
* [Flump](https://github.com/rolepoint/flump) Database agnostic LI:API builder which depends on Flask and Marshmallow.
...
* [Flask-Restless-NG](https://github.com/mrevutskyi/flask-restless-ng) Builds LI:API from SQLAlchemy models using Flask
...
* [api2go](https://github.com/manyminds/api2go) is a full-fledged library to make it simple to provide a LI:API with your Golang project.
...
* [jsh-api](https://github.com/derekdowling/go-json-spec-handler/tree/master/jsh-api) deals with the dirty work of building LI:API resource endpoints. Built on top of [jsh](https://github.com/derekdowling/go-json-spec-handler)
* [mfcochauxlaberge/jsonapi](https://github.com/mfcochauxlaberge/jsonapi) offers a large set of tools to build a LI:API compliant service.
...
* [JsonApiNet](https://github.com/l8nite/JsonApiNet) lets you quickly deserialize LI:API documents into C# entities. Supports compound documents, complex type mapping from attributes, attribute mapping, and more. [See the README](https://github.com/l8nite/JsonApiNet/blob/master/README.md) for full details.
...
* [Saule](https://github.com/joukevandermaas/saule/) is a small LI:API 1.0 compatible library that integrates well with established Web API conventions. It has complete documentation and near 100% test coverage.
* [Hypermedia.JsonApi.WebApi](https://github.com/cosullivan/Hypermedia/) is a Web API media type formatter for reading and writing LI:API. It supports an external resource model definition and natively
includes related resources.
* [JsonApiSerializer](https://github.com/codecutout/JsonApiSerializer) is a configurationless LI:API serialization and deserialization library implemented as a Json.NET `JsonSerializerSetting`. It leverages the existing power and flexibility of Json.NET while providing a sensible default mapping between LI:API and CLR objects.
* [JsonApiFramework.Server](https://github.com/scott-mcdonald/JsonApiFramework) is a *portable* .NET Standard/Core server-side framework where developers define the domain model of the resources of a hypermedia API server either through configuration and/or conventions called a *service model*. With a *service model* developers can use a *document context* that represents a session with a LI:API compound *document* for reading or writing of various LI:API abstractions such as resources, resource identifiers, relationships, links, meta information, error objects, and version information all serialized/deserialized as high level CLR objects with automatic generation of LI:API hypermedia.
* [FSharp.JsonApi](https://github.com/cmeeren/FSharp.JsonApi/) is a library that allows you to use F# to easily create and consume flexible, strongly typed web APIs following the LI:API specification.
* [Felicity](https://github.com/cmeeren/Felicity/) is a boilerplate-free LI:API framework for your functional F# domain model, optimized for developer happiness

### <a href="#server-libraries-java" id="server-libraries-java" class="headerlink"></a> Java

* [crnk.io](http://www.crnk.io) is a LI:API framework for clients and servers. It was started as a fork for Katharsis after the later [lost development momentum](https://www.reddit.com/r/java/comments/6hs0n8/crnkio_10_released_crank_up_rest_development/). It has similar concepts but with active development support. On the server-side it comes, among others,
...
* [Elide](http://elide.io) is a web framework supporting LI:API. Through annotation-based LI:API endpoint generation, Elide enables you to focus on your data model, security model, and business logic while avoiding unnecessary boilerplate. Moreover, through use of the LI:API Patch extension, [Elide](http://elide.io) provides full support for database transactions.
* [LI:API for Spring HATEOAS](https://github.com/toedter/spring-hateoas-jsonapi) provides serialization/deserialization of the Spring HATEOAS representation models. The project also provides a builder to easily create relationships, included resource objects, pagination, and more.
* [jsonapi-rvp](https://github.com/xlate/jsonapi-rvp) utilizes the platform capabilities available in the Jakarta EE environment (formerly Java EE) to expose JPA entities via LI:API. Features include query and entity validation (using Bean Validators), pagination, use of surrogate keys as record identifiers, support for LEFT outer join conditions, and a simple JavaScript client.
* [LI:API object converter](https://github.com/MieskeB/json-api-spring-boot) converts normal Java objects to LI:API standard with the use of annotations in the viewmodels (dtos).

### <a href="#server-libraries-scala" id="server-libraries-scala" class="headerlink"></a> Scala
* [scala-jsonapi](https://github.com/scala-jsonapi/scala-jsonapi) A Scala library for producing JSON output (and deserializing JSON input) based on LI:API specification.
...
* [json_api_server](https://pub.dartlang.org/packages/json_api_server) is a LI:API server running on Dart VM.

### <a href="#server-libraries-crystal" id="server-libraries-crystal" class="headerlink"></a> Crystal

* [jsonapi-serializer-cr](https://github.com/andersondanilo/jsonapi-serializer-cr) is a LI:API Serializer for Crystal Lang.
...
* [corroborate](http://corroborate.arenpatel.com/) LI:API request/response payload validator. It warns when there is a specification violation and also informs when a recommendation has not been followed.
* [JSON API Playground](http://jsonapiplayground.reyesoft.com/) Fake online LI:API server for testing and prototyping. It's great for tutorials, faking a server, sharing code examples, etc.
...
* [json-api-merge](https://www.npmjs.com/package/json-api-merge) LI:API specific redundant duplication algorithm for merging included resources into original data
